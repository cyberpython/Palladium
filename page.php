...
<div id="container">
                ...
                <div id="content">
                    ...
                    <ul id="posts-list">
                        ...
                        <?php if($title!=""){ ?>
                                            <h2 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( __('Permalink to %s', 'palladium'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
                        ...
                        <?php /* Microformatted category and tag links along with a comments link */ ?>
                                            <div class="entry-meta">
                                                <?php the_tags( '<span class="tag-links"><span class="entry-utility-prep entry-utility-prep-tag-links">' . __('Tagged ', 'palladium' ) . '</span>', ", ", "</span>\n\t\t\t\t\t\t<span class=\"meta-sep\">|</span>\n" ) ?>

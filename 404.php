                            ...
                            <ul id="posts-list">
                                <li>
                                    <div id="post-0" class="post error404 not-found">
                                            <h1 class="entry-title"><?php _e( 'Not Found', 'palladium' ); ?></h1>
                                            <div class="entry-title-shadow"></div>
                                            <div class="entry-content">
                                                    <p><?php _e( 'Apologies, but we were unable to find what you were looking for. Perhaps searching will help.', 'palladium' ); ?></p>
            <?php get_search_form(); ?>
                                            </div><!-- .entry-content -->
                                    </div><!-- #post-0 -->
